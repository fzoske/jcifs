...
// The next 2-1/2 lines of this should be placed with nTOWFv1 in place of password
	...
	{
		this(domain, username, passwordHash(password, Config.getInt("jcifs.smb.lmCompatibility", 3)));
	}
	...
	{
		return passwordHash(password, Config.getInt("jcifs.smb.lmCompatibility", 3));
	}
